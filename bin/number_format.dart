void numberFormatMainFunc() {
  print(numberFormat(554));
...
String numberFormat(
  ...
  for (int i = 0; i < reversedNumber.length; i += countPerDigit) {
    String currentNumber = '';
    if (i + countPerDigit > reversedNumber.length) {
      currentNumber = reversedNumber.substring(i, reversedNumber.length);
    } else {
      currentNumber = reversedNumber.substring(i, i + countPerDigit);
    }
